...
<%
	...
	if(request.getParameter("wid")==null){
		response.sendRedirect("remotehome.jsp");
		return;
	}
	String CourseID = request.getParameter("wid");
%>
<style>
	body{
		position:relative;
...
<div id="report-container">
	...
	<div id="rptDownload" style="margin-left: 1180px;display: none;">
		<a href="../../RemoteDownloadPDF?reptype=stud&cid=<%=CourseID%>&sid=<%=studentID%>&repname=ParticipantResult_Chart" target='_blank'> 
